...
;; Modifying half page up/page down bindings to also center the cursor
(defun scroll-up-and-center ()
  "Moves the cursor half a screen upward and centers view."
  (interactive)
  (evil-scroll-up 0)
...
(define-key evil-normal-state-map (kbd "C-u") #'scroll-up-and-center)
(define-key evil-normal-state-map (kbd "C-d") #'scroll-down-and-center)
